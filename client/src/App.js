            ...
            <div className="container mx-auto px-6 md:px-12 xl:px-32">
              <div className="text-center text-gray-800">
                <div className="block rounded-lg shadow-lg px-6 py-12 md:py-16 md:px-12" >
                  <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">Something Really Cool <br /><span class="text-red-600">make you click</span></h1>
                    <a className="inline-block px-7 py-3 mb-2 md:mb-0 mr-0 md:mr-2 bg-red-600 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-red-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-red-800 "  data-bs-toggle="modal" data-bs-target="#exampleModalCenteredScrollable" >Get started</a>
